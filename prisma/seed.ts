...
const umkmData = [
  {
    ...
    productCategories: [
      {
        ...
        products: [
          {
            name: "Sate Klopo Daging Sapi",
            price: 35000,
            isFeatured: true,
            photo: "/img/produk/sate-daging.svg",
            description: "Sate daging sapi empuk dengan bumbu kelapa gurih.",
          },
          {
            name: "Sate Klopo Ayam",
            price: 30000,
            isFeatured: true,
            photo: "/img/produk/sate-ayam.svg",
            description: "Sate ayam bumbu kelapa.",
          },
    ...
    reviews: [
      ...
      {
        rating: 4,
        comment: "Bumbu kelapanya unik, enak.",
        author: "KulinerSBY",
      },
    ],
  },
    ...
    productCategories: [
      {
        ...
        products: [
          {
            name: "Bebek Goreng + Sambal Pencit",
            price: 30000,
            isFeatured: true,
            photo: "/img/produk/bebek-sinjay.svg",
            description: "Paket bebek goreng + nasi + sambal pencit khas.",
          },
        ],
      },
      {
        name: "Menu Ayam",
        products: [{ name: "Ayam Goreng", price: 25000 }],
      },
      {
        name: "Minuman",
        products: [
  ...
  // --- TAMBAHKAN SISA DATA UMKM-MU DI SINI DENGAN FORMAT YANG SAMA ---
  {
    umkm: {
      ...
      description:
        "Pusat penjualan aneka tanaman hias, bunga potong, dan bibit.",
    ...
    productCategories: [
      ...
      {
        name: "Bunga Potong",
        products: [{ name: "Mawar (per tangkai)", price: 10000 }],
      },
    ],
    reviews: [
      {
        rating: 5,
        comment: "Pilihan tanamannya lengkap!",
        author: "Tante Hijau",
      },
    ],
  },
  ...
  // === KATEGORI MINUMAN ===
  {
    umkm: {
      ...
      description:
        "Kedai kopi specialty dengan biji kopi pilihan dan barista handal.",
        ...
        products: [
          {
            ...
            price: 28000,
            isFeatured: true,
            photo: "/img/produk/tuku-latte.svg",
            description: "Latte signature dengan foam art yang cantik.",
          },
          {
            name: "Cappuccino Classic",
            price: 25000,
            isFeatured: true,
            photo: "/img/produk/cappuccino.svg",
          },
    ...
    reviews: [
      {
        rating: 5,
        comment: "Kopinya premium banget! Latte artnya keren.",
        author: "Coffee Lover",
      },
      {
        rating: 4,
        comment: "Tempatnya cozy, cocok buat WFC.",
...

  {
    umkm: {
      ...
      description:
        "Minuman boba dan teh berkualitas dengan berbagai topping pilihan.",
        ...
        products: [
          {
            ...
            price: 24000,
            isFeatured: true,
            photo: "/img/produk/brown-sugar-milktea.svg",
            description: "Milk tea dengan brown sugar dan pearl.",
          },
    ...
    reviews: [
      {
        rating: 4,
        comment: "Brown sugar milk tea nya enak, pearlnya kenyal.",
        author: "Boba Addict",
      },
      {
        rating: 4,
        comment: "Rasa konsisten, pelayanan cepat.",
        author: "Student SBY",
      },
    ],
  },

  {
    umkm: {
      ...
      description:
        "Angkringan legendaris dengan es teh poci yang segar dan makanan ringan.",
        ...
        products: [
          {
            ...
            price: 3000,
            isFeatured: true,
            photo: "/img/produk/es-teh-poci.svg",
            description: "Es teh manis segar dari teko tanah liat.",
          },
    ...
    reviews: [
      {
        rating: 5,
        comment: "Es teh poci nya legend! Murah meriah.",
        author: "Anak Kost",
      },
      {
        rating: 4,
        comment: "Nostalgia banget, rasa autentik.",
        author: "Pak RT",
      },
    ],
  },
  ...
  // === KATEGORI JASA ===
  {
    ...
    productCategories: [
      {
        ...
        products: [
          {
            name: "Cuci Kering Regular (per kg)",
            price: 7000,
            isFeatured: true,
            photo: "/img/produk/cuci-kering.svg",
            description: "Layanan cuci kering standar.",
          },
          { name: "Cuci Setrika (per kg)", price: 10000, isFeatured: true },
          {
            name: "Cuci Express 6 jam (per kg)",
            price: 12000,
            isFeatured: false,
          },
        ],
    ...
    reviews: [
      {
        rating: 4,
        comment: "Bersih, wangi, harga terjangkau mahasiswa.",
        author: "Mahasiswa ITS",
      },
      {
        rating: 4,
        comment: "Pelayanan antar jemput membantu banget.",
...

  {
    umkm: {
      ...
      description:
        "Bengkel motor terpercaya dengan mekanik berpengalaman dan spare part lengkap.",
        ...
        products: [
          {
            ...
            price: 45000,
            isFeatured: true,
            photo: "/img/produk/ganti-oli.svg",
            description: "Paket ganti oli dengan filter udara.",
          },
    ...
    reviews: [
      {
        rating: 5,
        comment: "Pak Joko jujur, harga wajar, hasil memuaskan.",
        author: "Driver Ojol",
      },
      {
        rating: 4,
        comment: "Sudah langganan bertahun-tahun, terpercaya.",
...

  {
    umkm: {
      ...
      description:
        "Salon kecantikan lengkap untuk perawatan rambut dan wajah dengan terapis berpengalaman.",
        ...
        products: [
          {
            ...
            price: 35000,
            isFeatured: true,
            photo: "/img/produk/potong-rambut.svg",
            description: "Potong rambut dengan styling blow dry.",
          },
    ...
    reviews: [
      {
        rating: 4,
        comment: "Hasilnya bagus, mba nya ramah dan sabar.",
        author: "Mama Muda",
      },
      {
        rating: 4,
        comment: "Tempatnya bersih, alat steril.",
        author: "Cewek Hits",
      },
    ],
  },

  {
    umkm: {
      ...
      description:
        "Warnet dengan fasilitas lengkap plus layanan print, scan, dan fotocopy.",
    ...
    productCategories: [
      {
        ...
        products: [
          {
            name: "Internet per jam",
            price: 3000,
            isFeatured: true,
            photo: "/img/produk/warnet.svg",
            description: "Akses internet unlimited per jam.",
          },
    ...
    reviews: [
      {
        rating: 4,
        comment: "Internet cepat, cocok buat ngerjain tugas.",
        author: "Mahasiswa Teknik",
      },
      {
        rating: 4,
        comment: "Buka 24 jam, sangat membantu deadline.",
        author: "Anak Skripsi",
      },
    ],
  },
...
async function main() {
  ...
  for (const data of umkmData) {
    ...
    if (!categoryId) {
      console.warn(
        `Kategori UMKM "${umkmInfo.categorySlug}" tidak ditemukan. UMKM "${umkmInfo.name}" dilewati.`
      );
      continue;
    }
  ...
  await Promise.all([
    ...
    prisma.review.create({
      data: {
        rating: 5,
        comment:
          "Dari jaman kuliah udah langganan di sini, ga pernah mengecewakan",
        userId: users[2].id,
        umkmId: bakso.id,
      },
    }),
