...
export default function WelcomeModal() {
  ...
  useEffect(() => {
    ...
    const shouldShowModal =
      isPelanggan &&
      (justRegistered || !hasSeenUmkmWelcome || shouldShowBasedOnTimePassed);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-lg border shadow-lg bg-background rounded-lg">
        <DialogHeader>
        ...
        <div className="py-4 space-y-4">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-3 bg-primary rounded-full flex items-center justify-center shadow-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Mulai berjualan dan jangkau lebih banyak pelanggan dengan
              mendaftarkan UMKM Anda di platform kami!
            </p>
          </div>
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-col">
          ...
          >
            <Link href="/profil?section=umkm">Daftarkan UMKM Saya</Link>
          </Button>
