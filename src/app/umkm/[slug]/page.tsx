        ...
        <div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-start">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 text-yellow-500 mt-2">
              ...
              <span className="text-muted-foreground">({umkm.Review.length} ulasan)</span>
            </div>
          </div>
          ...
          <div className="space-y-4 rounded-lg border p-4 h-fit">
            ...
            <div className="w-full h-64 rounded-md overflow-hidden">
              {umkm.latitude && umkm.longitude ? (
                <MapWrapper latitude={umkm.latitude} longitude={umkm.longitude} popupText={umkm.name} />
              ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-0.5 mt-1">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`h-4 w-4 ${i < review.rating ? 'text-yellow-500 fill-yellow-500' : 'text-gray-400 dark:text-gray-500'}`}
                      />
                    ))}
                  </div>
